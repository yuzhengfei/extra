...
class ReleasePro(db.Model):
    ...
    def __init__(self, employer_id, project_name, first_type, second_type, describe, budget, cycle, company, integral):
...
class Question(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    userId = db.Column(db.Integer, db.ForeignKey('user.id'))
    content = db.Column(db.String(500), unique=False, default='')
...
class Answer(db.Model):
    ...
    def __init__(self, question_id, user_id, content):

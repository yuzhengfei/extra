...
# 路由分发
from server.resources.answerSave import AnswerSave
from server.resources.questionDetail import QuestionDetail
from server.resources.questionList import QuestionList
from server.resources.questionSave import QuestionSave
from . import api
...
api.add_resource(QuestionSave, '/questionSave')
api.add_resource(QuestionList, '/questionList')
api.add_resource(QuestionDetail, '/questionDetail')
api.add_resource(AnswerSave, '/answerSave')

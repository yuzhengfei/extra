...
class AdminLogin(flask_restful.Resource):
    def get(self):
...
class ShowUsers(flask_restful.Resource):
    def get(self):
        parser = reqparse.RequestParser()
...
class ShowPro(flask_restful.Resource):
    def get(self):
        parser = reqparse.RequestParser()
        parser.add_argument('page', type=int, required=True, help='page is required')
...
class HandleUser(flask_restful.Resource):
    def get(self):
        parser = reqparse.RequestParser()
...
class ShowAppeals(flask_restful.Resource):
    def get(self):
        parser = reqparse.RequestParser()
        parser.add_argument('page', type=int, required=True, help='page is required')
        parser.add_argument('type', type=str, required=True, help='type is required')
...
class Submit(flask_restful.Resource):
    def post(self):
        parser = reqparse.RequestParser()
        parser.add_argument('id', type=int, required=True, help='id is required')
...
class changeAdv(flask_restful.Resource):
    def post(self):
        parser = reqparse.RequestParser()
...
class HandlePro(flask_restful.Resource):
    def get(self):
        parser = reqparse.RequestParser()
